                ...
                <form method="POST" action="{{ route('expenses.update', $expense) }}">
                    ...
                    <div class="row g-3 mb-3 d-none" id="companyFields">
                        <div class="col-md-6">
                            ...
                            <select name="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror">
                                ...
                                <option value="{{ $company->id }}" {{ old('supplier_id', $expense->supplier_id) == $company->id ? 'selected' : '' }}>{{ $company->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="bill_number" class="form-control" value="{{ old('bill_number', $expense->bill_number) }}" placeholder="e.g. INV-2026-104">
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check2 me-2"></i>Update Expense
                        </button>
