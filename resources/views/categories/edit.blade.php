    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header py-3">
                <i class="bi bi-pencil me-2"></i>Edit: {{ $category->name }}
            </div>
            <div class="card-body">
                <form action="{{ route('categories.update', $category) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="product_type" class="form-select @error('product_type') is-invalid @enderror" required>
                            <option value="medicine" {{ old('product_type', $category->product_type) === 'medicine' ? 'selected' : '' }}>Medicine (Box / Strip / Tablet)</option>
                            <option value="liquid" {{ old('product_type', $category->product_type) === 'liquid' ? 'selected' : '' }}>Syrup / Liquid / Cream / Injection / Drops</option>
                            <option value="general" {{ old('product_type', $category->product_type) === 'general' ? 'selected' : '' }}>General Item (single piece)</option>
                        </select>
                            ...
                            <div class="row g-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="default_almari" class="form-control form-control-sm @error('default_almari') is-invalid @enderror"
                                        value="{{ old('default_almari', $category->default_almari) }}" placeholder="e.g. Almari 3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="default_khana" class="form-control form-control-sm @error('default_khana') is-invalid @enderror"
                                        value="{{ old('default_khana', $category->default_khana) }}" placeholder="e.g. Khana 2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="default_row" class="form-control form-control-sm @error('default_row') is-invalid @enderror"
                                        value="{{ old('default_row', $category->default_row) }}" placeholder="e.g. Row 1">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="default_mfg_date" class="form-control form-control-sm @error('default_mfg_date') is-invalid @enderror"
                                        value="{{ old('default_mfg_date', $category->default_mfg_date) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="default_expiry_date" class="form-control form-control-sm @error('default_expiry_date') is-invalid @enderror"
                                        value="{{ old('default_expiry_date', $category->default_expiry_date) }}">
